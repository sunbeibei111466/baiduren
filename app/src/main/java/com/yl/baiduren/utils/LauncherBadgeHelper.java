...
/**
 * Created by Android_apple on 2018/2/2.
 */
...
public class LauncherBadgeHelper {
    ...
    private static void sendToSony(Context context, int count) {
        ...
        localIntent.putExtra("com.sonyericsson.home.intent.extra.badge.MESSAGE", String.valueOf(count == 0 ? "" : count));//数字
    ...
    private static void sendToSamsumg(Context context, int count) {
        ...
        intent.putExtra("badge_count", String.valueOf(count));
