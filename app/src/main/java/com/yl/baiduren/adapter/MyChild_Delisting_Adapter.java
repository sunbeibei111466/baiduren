...
public class MyChild_Delisting_Adapter extends RecyclerView.Adapter<My_Delist_ViewHolder> {
    private MyChild_Delisting context;
    private List<My_Delisting_Result.DataListBean> dataList;

    public MyChild_Delisting_Adapter(MyChild_Delisting context) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {//债事详情
                context.startActivity(new Intent(context, Debt_Details.class)
                        ...
                        .putExtra("comePager", Constant.PAGER_MY_CHILD_ZHAIPAI)
                );
            }
        });
