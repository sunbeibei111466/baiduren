...
public class My_Deliting_Drawlay_Adapter extends BaseAdapter {
    private My_Delisting debtBunessHall;
    private List<Debt_Type_Result.CategoryDO> list;
    private int index;


    public My_Deliting_Drawlay_Adapter(My_Delisting context ) {
