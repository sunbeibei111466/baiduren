...
import com.yl.baiduren.activity.supply_demand.Upload_Demend;
...
public class Upload_Demend_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    private Upload_Demend context;
    private List<CategoryDo> list;

    public Upload_Demend_Adapter(Upload_Demend debt_three_debtorAssets, List<CategoryDo> list) {
