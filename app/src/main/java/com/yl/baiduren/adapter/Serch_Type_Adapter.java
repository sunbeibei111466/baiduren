...
public class Serch_Type_Adapter extends RecyclerView.Adapter<My_Serch_Viewholder> {
    private SparseBooleanArray mSelectedPositions = new SparseBooleanArray();
    private boolean mIsSelectable = false;
    private Context context;
    List<Debt_Type_Result.CategoryDO> list;

    public Serch_Type_Adapter(Context context) {
    ...
    public void onBindViewHolder(final My_Serch_Viewholder holder, final int position) {
        Debt_Type_Result.CategoryDO categoryDO = list.get(position);
        holder.checkBox.setText(categoryDO.getName());
...
class My_Serch_Viewholder extends RecyclerView.ViewHolder {
    public RadioButton checkBox;

    public My_Serch_Viewholder(View itemView) {
        super(itemView);
