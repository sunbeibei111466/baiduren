...
/**
 * Created by Android_apple on 2018/1/22.
 */

public class FloatDragView {

    private Activity context; // 上下文
    private TextView mImageView; // 可拖动按钮
     ...
     */
    public static TextView addFloatDragView(Activity context , RelativeLayout mViewContainer,
                                             View.OnClickListener clickListener) {
        FloatDragView floatDragView = new FloatDragView(context);
        TextView imageView = floatDragView.getFloatDragView(clickListener);
    ...
    // 获取可拖动按钮的实例
    private TextView getFloatDragView(View.OnClickListener clickListener) {
        if (mImageView != null) {
            return mImageView;
        } else {
            mImageView = new TextView(context);
            mImageView.setClickable(true);
            mImageView.setFocusable(true);
            mImageView.setBackground(context.getResources().getDrawable(R.drawable.float_button_bg));
            mImageView.getBackground().setAlpha(80);
            mImageView.setText("返回APP");
            mImageView.setTextSize(12);
            mImageView.setTextColor(context.getResources().getColor(R.color.white));
            mImageView.setGravity(Gravity.CENTER);
    ...
    // 可拖动按钮的touch事件
    private void setFloatDragViewTouch(final TextView floatDragView) {
