...
public class Debt_Transfer_Platform_Hall_Activity extends BaseActivity {
    ...
    public int loadWindowLayout() {
        return R.layout.debt_transfre_platform_hall;
    }

    @Override
    public void initViews() {
        refreshLayout = findViewById(R.id.rl_platform_refresh);
        refreshLayout.setMaterialRefreshListener(refreshListener);
        recyclerView = findViewById(R.id.debt_platform_recylcer);
        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        iv_company_back = findViewById(R.id.iv_platform_back);
