...
import com.yl.baiduren.fragment.supply_demend_hall_fragment.Demend_Hall_Fragment;
import com.yl.baiduren.fragment.supply_demend_hall_fragment.Supply_Hall_Fragment;
...
public class Supply_Demend_Hall extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public int loadWindowLayout() {
        return R.layout.supply_demend_hall;
    }

    @Override
    public void initViews() {
        ImageView supply_demend_back = findViewById(R.id.supply_demend_back);
        supply_demend_back.setOnClickListener(this);
        ImageView supply_demend_serch = findViewById(R.id.supply_demend_serch);
        supply_demend_serch.setOnClickListener(this);
        Button mine_collection = findViewById(R.id.mine_collection);
        mine_collection.setOnClickListener(this);
        Button mine_add = findViewById(R.id.mine_add);
    ...
    private void initview() {
        ...
        Supply_Hall_Fragment supply_hall_fragment = new Supply_Hall_Fragment();
        Demend_Hall_Fragment demend_hall_fragment = new Demend_Hall_Fragment();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_Wf2:
                ...
                break;
            case R.id.supply_demend_back:
                finish();
                break;
            case R.id.supply_demend_serch://搜寻

                Intent intent = new Intent(this, Hall_Supply_Resch.class);
                intent.putExtra("comePager", Constant.GX_DT);
                startActivity(intent);
                break;
            case R.id.mine_collection://我的收藏
                startActivity(new Intent(this, My_Collection_Activity.class));
                break;
            case R.id.mine_add://新增
