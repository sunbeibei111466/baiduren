...
import com.yl.baiduren.fragment.my_collection_fragment.My_Demend_Fragment_Collection;
import com.yl.baiduren.fragment.my_collection_fragment.My_Supply_Fragment_Collection;
...
public class My_Collection_Activity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void initViews() {
        ImageView my_collction_back = findViewById(R.id.my_collction_back);
        my_collction_back.setOnClickListener(this);
        ImageView my_colletion_serch = findViewById(R.id.my_colletion_serch);
        my_colletion_serch.setOnClickListener(this);
        Button my_collection_add = findViewById(R.id.my_collection_add);
        my_collection_add.setOnClickListener(this);
        initview();
    ...
    private void initview() {
        ...
        My_Supply_Fragment_Collection supply_hall_fragment = new My_Supply_Fragment_Collection();
        My_Demend_Fragment_Collection demend_hall_fragment = new My_Demend_Fragment_Collection();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_Wf2:
                ...
                break;
            case R.id.my_collction_back:
                finish();
                break;
            case R.id.my_colletion_serch://搜寻
                int curent = viewPager.getCurrentItem();
                Intent intent = new Intent(this, Hall_Supply_Resch.class);
                intent.putExtra("comePager", Constant.MY_SC_DT);
                startActivity(intent);
                break;
            case R.id.my_collection_add://新增
