...
public class Speed_Demd_Dating_Result extends BaseActivity implements Supply_Hall_Adapter.Item_getId{
    ...
    public int loadWindowLayout() {
        return R.layout.speed_dating_result;
    }

    @Override
    public void initViews() {
        //匹配id
        match_id = getIntent().getLongExtra("match_demend_id", 0);
        speed_result_back = findViewById(R.id.speed_result_back);//关闭
        speed_result_back.setOnClickListener(listener);
        refreshLayout = findViewById(R.id.speed_result_refresh);
        refreshLayout.setMaterialRefreshListener(refreshListener);
        recyclerView = findViewById(R.id.speed_result_recyclerview);
        LinearLayoutManager manager =new LinearLayoutManager(this);
        manager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(manager);
        adapter = new Supply_Hall_Adapter(this);
        ...
        if (baseRequests.size()!=0){
            ...
            BaseObserver<My_Supply_Result> baseObserver = new BaseObserver<My_Supply_Result>(this) {
                ...
                protected void onSuccees(String code, My_Supply_Result data, BaseRequest baseResponse) throws Exception {
                    if (code.equals("1")) {
                        UserInfoUtils.setUuid(Speed_Demd_Dating_Result.this, baseResponse);
            ...
            RetrofitHelper.getInstance(this).getServer()
                    .need_Mathes(signature, RequestBody.create(MediaType.parse(Constant.JSON), json))
    ...
    private void collection_Suplly(Long supp_id) {//点击收藏
        ...
        BaseObserver<String> baseObserver = new BaseObserver<String>(this) {
            ...
            protected void onSuccees(String code, String data, BaseRequest baseResponse) throws Exception {
                if (code.equals("1")) {
                    UserInfoUtils.setUuid(Speed_Demd_Dating_Result.this, baseResponse);
                    ToastUtil.showShort(Speed_Demd_Dating_Result.this,"收藏成功");
                    refreshLayout.autoRefresh();
                }else {
                    ToastUtil.showShort(Speed_Demd_Dating_Result.this,"收藏失败");
                }
