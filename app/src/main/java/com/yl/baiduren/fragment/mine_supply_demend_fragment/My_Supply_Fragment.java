 ...
 * 供应端
 */
public class My_Supply_Fragment extends BaseFragment {
    private MaterialRefreshLayout refreshLayout;
    private RecyclerView supply_hall_recycleview;
    private My_Supply_Adpater adapter;
    ...
    public int loadWindowLayout() {
        return R.layout.my_supply_fragment;
    }

    @Override
    public void initViews(View rootView) {
        refreshLayout = rootView.findViewById(R.id.my_supply_refresh);
        refreshLayout.setMaterialRefreshListener(refreshListener);
        supply_hall_recycleview = rootView.findViewById(R.id.my_supply_recycleview);
        LinearLayoutManager manager =new LinearLayoutManager(getActivity());
        manager.setOrientation(LinearLayoutManager.VERTICAL);
        supply_hall_recycleview.setLayoutManager(manager);
        adapter = new My_Supply_Adpater(getActivity());
