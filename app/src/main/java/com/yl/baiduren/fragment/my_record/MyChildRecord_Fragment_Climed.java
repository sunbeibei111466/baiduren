...
import com.yl.baiduren.adapter.MyChildRecord_Fragmnet_Climed_Adapter;
...
public class MyChildRecord_Fragment_Climed extends BaseFragment implements IDeleteCall {
    ...
    private MyChildRecord_Fragmnet_Climed_Adapter adapter;
    ...
    public void initViews(View rootView) {
        ...
        adapter = new MyChildRecord_Fragmnet_Climed_Adapter(getContext(), childUserId);
    ...
    private void displayData(final My_Record_Result data) {
        ...
        if (status == REFRESH) {
            ...
            adapter.setFragment_climed(MyChildRecord_Fragment_Climed.this);
        }
        if (status == LOADMORE) {
